class Berles:  # class kulcsszóval deklarálok egy Berles nevű osztályt
    ...
    felhasznalo_nev = property(get_felhasznalo_nev,
                               set_felhasznalo_nev)  # létrehozok egy felhasznalo_nev attribútumot és a property függvénnyel megadom, hogy a get_felhasznalo_nev és set_felhasznalo_nev tartozik hozzá

    def __str__(
            self):  # definiálok egy string metódust (dunder metódus), ami akkor fog meghívódni, amikor az osztálypéldányra ráhívok egy print-et
